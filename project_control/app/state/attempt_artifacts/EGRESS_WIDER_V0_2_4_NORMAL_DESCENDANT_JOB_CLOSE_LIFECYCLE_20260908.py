...
PARENT_ATTEMPT_ID = "attempt-egress-wider-v0-2-3-descendant-proxy-env-loopback-bounded-admission"
ATTEMPT_ID = "attempt-egress-wider-v0-2-4-normal-descendant-job-close-lifecycle-first"
...
def _emit(result: dict[str, object], exit_code: int) -> int:
    result["schema"] = "singularity-works.egress-wider-v0.2.4-normal-descendant-job-close-result/0.1"
