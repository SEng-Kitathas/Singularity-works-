...
"""Frozen wider-egress v0.2.4.1: normal descendant Job-close lifecycle stdio repair.
...
v0.2.4.1 changes only the unprotected positive-control subprocess stdio from
captured pipes to DEVNULL so the sleeping descendant cannot retain harness pipes.
Root/child command, sleep duration, protected phase, cwd, PID probe, cleanup and
claim ceiling are unchanged from immutable v0.2.4 Attempt 0.
...
PARENT_ATTEMPT_ID = "attempt-egress-wider-v0-2-4-normal-descendant-job-close-first-result"
ATTEMPT_ID = "attempt-egress-wider-v0-2-4-1-normal-descendant-job-close-lifecycle-stdio-repair-first"
...
def _emit(result: dict[str, object], exit_code: int) -> int:
    result["schema"] = "singularity-works.egress-wider-v0.2.4.1-normal-descendant-job-close-result/0.1"
