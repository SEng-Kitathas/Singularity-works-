...
"""Frozen wider-egress v0.2.6: ShellExecuteExW process-lifecycle discriminator.
...
EXPECTED_CONTROL_HEAD = "8a401838b8e4d5d8b0be669ac98a9bdaec37580d"
EXPECTED_CONTROL_CHECKPOINT = "28904a9d34ebc80b46eec719a1987acdebc92c476458357dbe3cf772b369b1a2"
GEN14_CHECKPOINT = "checkpoint-app-live-0014-43aa7feac7e8"
PARENT_ATTEMPT_ID = "attempt-egress-wider-v0-2-5-4-explicit-job-breakaway-bounded-admission"
ATTEMPT_ID = "attempt-egress-wider-v0-2-6-shellexecuteex-process-lifecycle-first"
...
def _emit(result: dict[str, object], exit_code: int) -> int:
    result["schema"] = "singularity-works.egress-wider-v0.2.6-shellexecuteex-process-lifecycle-result/0.1"
