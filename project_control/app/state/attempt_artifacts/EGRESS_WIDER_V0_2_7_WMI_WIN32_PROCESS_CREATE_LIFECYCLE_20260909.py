...
"""Frozen wider-egress v0.2.7: WMI Win32_Process.Create lifecycle discriminator.
...
EXPECTED_CONTROL_HEAD = "b8c5e6f9c7032e2a25c25ac4b4e50de91183d64c"
EXPECTED_CONTROL_CHECKPOINT = "59643050ecd2c741ca81253c59f1ce88e9344866a683420a9f90c702d46c1520"
GEN14_CHECKPOINT = "checkpoint-app-live-0014-43aa7feac7e8"
PARENT_ATTEMPT_ID = "attempt-egress-wider-v0-2-6-1-shellexecuteex-bounded-admission"
ATTEMPT_ID = "attempt-egress-wider-v0-2-7-wmi-win32-process-create-lifecycle-first"
...
def _root_command(powershell: Path) -> list[str]:
    ...
    script = (
        ...
        "$pid=[uint32]$r.ProcessId; if($pid -eq 0){ exit [int]0x50000001 }; "
        "exit [int](0x10000000 -bor ($pid -band 0x0FFFFFFF))"
    )
...
def _emit(result: dict[str, object], exit_code: int) -> int:
    result["schema"] = "singularity-works.egress-wider-v0.2.7-wmi-win32-process-create-result/0.1"
