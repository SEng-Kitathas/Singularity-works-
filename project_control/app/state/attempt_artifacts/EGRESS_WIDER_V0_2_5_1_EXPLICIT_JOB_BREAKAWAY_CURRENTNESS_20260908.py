...
"""Frozen wider-egress v0.2.5.1: explicit CREATE_BREAKAWAY_FROM_JOB currentness sibling.
...
v0.2.5.1 changes no discriminator behavior from immutable preserved v0.2.5.
It binds the compatible continuity-pointer repair control generation a95ec535... /
CHECKPOINT 09bdf45b... after v0.2.5 was preserved under predecessor 5c052d8....
Helper source/DLL hashes, positive/protected commands, outer-Job gate, decoding,
cleanup, PASS/FAIL criteria, network scope and claim ceiling are unchanged.
"""
...
EXPECTED_CONTROL_HEAD = "a95ec5355b6946927eec6403a1764491f837e9e2"
EXPECTED_CONTROL_CHECKPOINT = "09bdf45b6aa912da4f97e4f142387dc80f9ac093a5fab7885f004e1ed9aecc7d"
GEN14_CHECKPOINT = "checkpoint-app-live-0014-43aa7feac7e8"
PARENT_ATTEMPT_ID = "attempt-egress-wider-v0-2-5-explicit-job-breakaway-first"
ATTEMPT_ID = "attempt-egress-wider-v0-2-5-1-explicit-job-breakaway-currentness-first"
...
def _emit(result: dict[str, object], exit_code: int) -> int:
    result["schema"] = "singularity-works.egress-wider-v0.2.5.1-explicit-job-breakaway-result/0.1"
