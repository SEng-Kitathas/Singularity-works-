...
## WMI harness guard — 2026-09-09
`WMI_CREATE_SUCCESS_RETURN != VALID_CHILD_LIFECYCLE_OBSERVATION`; `POSITIVE_PID_CAPTURE_FAILURE != PROTECTED_WMI_DENIAL`; `HARNESS_INVALID != SAFE_TO_REPLAY_SAME_ATTEMPT`.


## WMI positive/protected separation — 2026-09-09
`POSITIVE_WMI_SERVICE_MEDIATION != PROTECTED_WMI_CONTAINMENT`; `PROTECTED_CLASS_BIND_EXCEPTION != JOB_SPECIFIC_DENIAL`; `HRESULT_ENCODER_FAILURE != WMI_PATH_RESULT`.
