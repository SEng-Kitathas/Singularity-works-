...
"""Exact-evidence source materializer for Forge semantic deltas.
...
from forge_semantic_fact_ir_v0_1_2 import FrozenSemanticFactBundle
from forge_semantic_snapshot_delta_v0_4 import fact_semantic_key

VERSION = "forge.semantic-materializer/0.1.1"
# v0.1.1 changes only semantic-continuity-key dependency v0.3 -> qualified v0.4.
